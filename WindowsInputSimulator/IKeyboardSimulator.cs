...
namespace WindowsInputSimulator
{
  ...
  public interface IKeyboardSimulator
  {
    ...
    /// </summary>
    /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
    IKeyboardSimulator UnicodeKeyPress(char unicode);

    /// <summary>
    /// Simulates a key press for each of the specified key codes in the order they are specified.
    /// </summary>
    /// <param name="keyCodes"></param>
    IKeyboardSimulator UnicodeKeyPress(params char[] unicodes);
    ...
    /// The flow is Modifiers KeyDown in order, VirtualKeyCode Press, Modifiers KeyUp in reverse order.
    /// </summary>
    /// <param name="modifierKeyCodes">The list of <see cref="VirtualKeyCode"/>s for the modifier keys.</param>
    /// <param name="keyCode">The <see cref="VirtualKeyCode"/> for the key.</param>
    ...
    /// The flow is Modifier KeyDown, VirtualKeyCode Press, Modifier KeyUp.
    /// </summary>
