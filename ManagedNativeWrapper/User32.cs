...
namespace ManagedNativeWrapper
{
  public static class User32
  {
    ...
    [DllImport("User32.dll")]
    public static extern int GetWindowLong(IntPtr hWnd, WindowLongEnum nIndex);
    [DllImport("User32.dll")]
    public static extern int SetWindowLong(IntPtr hWnd, WindowLongEnum nIndex, int dwNewLong);
    ...
    [DllImport("User32.dll")]
    public static extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, SetWindowPositionFlag uFlags);
  }
}
