...
namespace WW.WPF.VirtualKeyboard.ModelView
{
  ...
  public class KeyboardModelView : INotifyPropertyChanged, IDisposable
  {
        ...
        default:
          {
            ...
            if ((Properties.Settings.Default.ExitOnEnterPress && !Properties.Settings.Default.HideTitleBar) || Properties.Settings.Default.HideTitleBar && value == VirtualKeyCode.Return)
            {
              //if this is true, just shut down.
    ...
    private void SendKeyeboardData(char value, bool? shiftButtonClicked, bool CleanLastChar)
    {
      ...
      if (char.IsLetter(value) && shiftButtonClicked != false)
      {
      ...
      if (shiftButtonClicked == null)
      {
        ShiftButtonClicked = false;
      }
    }
  }
}
